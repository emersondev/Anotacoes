...
INSERT INTO CLIENTES VALUES('JOAO','M','JOAO@GMAIL.COM',01234567890,'38072116', 'AMPARO - SP');
INSERT INTO CLIENTES VALUES('FRANCISCA','F','FRANCISCA@GMAIL.COM',01234567892,'38072146', 'CAMPINAS - SP');
INSERT INTO CLIENTES VALUES('JORGE','M',NULL,01234567891,'38072626', 'SERRA NEGRA - SP');
INSERT INTO CLIENTES VALUES('ZELIA','F',NULL,01234567891,'12312445', 'PATO BRANCO - PR');

/* FORMA 02 - COLOCANDO AS COLUNAS - posso colocar na ordem que eu quiser e seguir a mesma ordem na inserção do values*/
INSERT INTO CLIENTES(NOME,SEXO,CPF,TELEFONE,ENDERECO,EMAIL) VALUES('DIOGO','M',01234567898,'38072856', 'AMPARO - SP','DIOGO@GMAIL.COM');
INSERT INTO CLIENTES(NOME,SEXO,CPF,TELEFONE,ENDERECO,EMAIL) VALUES('CELIA','F',01234567897,'37572116', 'JAGUARIUNA - SP','CELIA@GMAIL.COM');
INSERT INTO CLIENTES(NOME,SEXO,CPF,TELEFONE,ENDERECO,EMAIL) VALUES('JOANA','F',01234567896,'33972116', 'PEDREIRA - SP','JOANA@GMAIL.COM');
INSERT INTO CLIENTES(NOME,SEXO,CPF,TELEFONE,ENDERECO,EMAIL) VALUES('CLARA','F',99999999999,'33972116', 'PEDREIRA - SP','CLARA@GMAIL.COM');
...
SELECT EMAIL, ENDERECO, NOME, SEXO FROM CLIENTES;

SELECT EMAIL, ENDERECO, NOME, SEXO, NOW() AS DATA_HORA FROM CLIENTES;
...
/* Da falha pois procura exatamente SP */
SELECT NOME, SEXO FROM CLIENTES
WHERE ENDERECO = 'SP';
...
/* CARACTER CORINGA % -> QUALQUER COISA, ex: %SP -> qualquer coisa antes que termine com SP */
...
/*
SELECT NOME, SEXO FROM CLIENTES
WHERE ENDERECO LIKE '%______AMPARO______%';
seria um exemplo de comando de pesquisa que tem 
6 underscore(alguma coisa) antes a palava AMPARO 6 underscore depois
*/
...
WHERE SEXO = 'M' OR ENDERECO LIKE 'AMPARO%';

SELECT NOME, SEXO, ENDERECO FROM CLIENTES
WHERE SEXO = 'F' OR ENDERECO LIKE 'PEDREIRA%';

/* AND - E */
SELECT NOME, SEXO, ENDERECO FROM CLIENTES
WHERE SEXO = 'M' AND ENDERECO LIKE 'AMPARO%';

SELECT NOME, SEXO, ENDERECO FROM CLIENTES
WHERE SEXO = 'F' AND ENDERECO LIKE 'PEDREIRA%';

/* COUNT(*), GROUP BY, PERFORMANCE COM OPERADORES LÓGICOS */

SELECT COUNT(*) AS "Quantidade de registros da tabela Clientes" FROM CLIENTES; 
...
ORDER BY 1;
 ...
 -- 21 funcionários em Filmes e 53 em Roupas
 
 /* 2º Passo montagem da query, lógica, como sabemos que vamos procurar do departamento de roupas
ou do departamento de filmes, colocamos na primeira condição o que tem mais de ser verdadeiro,
pois otmizamos o banco a não chegar a segunda condição, dado que a primeira foi realizada */
...
-- EXERCÍCIO DOIS: O gestor de marketing pediu a lista das funcionarias (AS) = FEMININO que trabalhem no departamento 
...
-- Minha resolução
SELECT NOME, SEXO, DEPARTAMENTO, EMAIL FROM FUNCIONARIOS WHERE (DEPARTAMENTO = 'filmes' OR DEPARTAMENTO = 'lar') AND SEXO = 'Feminino';

-- EXERCÍCIO 3: Traga os funcionarios do sexo masculino
...
/* 2º passo, pensando na performance, nesse comando ele vai contar quantos funcionarios
 tem cada departamento, agrupar o resultado por dpto
 e o order by vai colocar em ordem crescente pra saber o maior pro menor*/
...
SELECT * FROM CLIENTES WHERE NOME = 'CELIA';

SELECT COUNT(*) FROM CLIENTES; -- TOTAL 7
...
INSERT INTO CLIENTES VALUES('CARLA','F','C.LOPES@UOL.COM',45638854,'4575-0048',
...
SHOW TABLES; --> Pra saber quais tabelas existem
...
INSERT INTO CLIENTE VALUES(NULL, 'JOAO', 'M', 'JOAO@IG.COM', '30867809086');
...
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '78849543', 5);
INSERT INTO TELEFONE VALUES(NULL, 'RES', '54394421', 5);
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '68243812', 1);
INSERT INTO TELEFONE VALUES(NULL, 'COM', '84341484', 6);
INSERT INTO TELEFONE VALUES(NULL, 'RES', '12351262', 1);
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '12321341', 3);
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '98949814', 3);
INSERT INTO TELEFONE VALUES(NULL, 'COM', '67877123', 1);
INSERT INTO TELEFONE VALUES(NULL, 'RES', '68667867', 5);
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '82173986', 6);
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '79746464', 7);
INSERT INTO TELEFONE VALUES(NULL, 'RES', '12325436', 7);
...
SELECT NOW() AS DATA_ATUAL; --> NOW MOSTRA A DATA ATUAL
